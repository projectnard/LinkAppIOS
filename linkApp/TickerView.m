...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.scrollview == nil) {
        ...
        //set the text
        ticker.marqueeStr = @"This is a sample ios marquee using scrollview and timer. You can also manually control it by scrolling left
        or right, or touch on it to stop it, and release it to auto restart the marquee.";
        //set the font
